...
export function NoteCard({ note, onNoteDeleted }: INoteCardProps) {
    return (
        <Dialog.Root>
            {/* Card */}
            <Dialog.Trigger className='rounded-md text-left flex flex-col p-5 gap-3 bg-slate-800 outline-none overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
